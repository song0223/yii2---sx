    ...
    <div class="panel panel-default">
        <div class="panel-heading media clearfix">
            <div class="media-body">
                <?= Html::tag('h1', Html::encode(1111), ['class' => 'media-heading']); ?>
                <div class="info">
                    <?= Html::a(
                        22,
                        ['/post/default/index', 'node' => 3],
                        ['class' => 'node']
                    ) ?>
                    ·
                    <?= Html::a(4, ['/user/default/show', 'username' => 5]) ?>
                    ·
                    于 <?= Html::tag('abbr', 6, ['title' => 7]) ?>发布
                    ·
...
<div class="col-md-3 side-bar p0">
    ...
    <div class="panel panel-default corner-radius">
        ...
        <div class="panel-body text-center">
            <div class="btn-group">
                <a class="btn btn-success" href="<?=Url::to(['default/create'])?>">发布新帖</a>                </div>
        </div>
    </div>
