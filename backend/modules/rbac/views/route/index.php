    ...
    <div class="col-sm-11">
        <div class="input-group">
            <input id="inp-route" type="text" class="form-control"
                   placeholder="<?= Yii::t('rbac-admin', 'New') ?>">
            <span class="input-group-btn">
                <?= Html::a(Yii::t('rbac-admin', 'New') . $animateIcon, ['create'], [
...
<div class="row">
    <div class="col-sm-5">
        <div class="input-group">
            <input class="form-control search" data-target="avaliable"
                   placeholder="<?= Yii::t('rbac-admin', 'Avaliable') ?>">
            <span class="input-group-btn">
    ...
    <div class="col-sm-5">
        <input class="form-control search" data-target="assigned"
               placeholder="<?= Yii::t('rbac-admin', 'Assigned') ?>">
